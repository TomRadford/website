...
In 2024, when I was originally planning this, the idea was to cook up a nuxt site (mostly because I was playing with vue/nuxt at the time and I kinda loved it).
...
I deliberated a lot of what domain to use for this website.

I have a number of variations of `rad` domain, but the domain you're reading this on (theradford.com) is a very special one...

It's the **first domain I ever purchased** when I was in Grade 7. I needed something to use for my self-hosting endeavours (port-forwarding an ubuntu box on my parent's 384k ADSL line 😂).

And, after much deliberation, I think it's kinda perfect to repurpose for this (my awesome website!)

![Young Tom was onto something with his first domain purchase](./domain.png)
