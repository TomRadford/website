      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-10">
        ...
        <div className="space-y-4  sm:w-1/2">
          <Typography element="h4" weight="default" size="h4">
            I'm a <Link href="/creative-engineer">creative engineer</Link> who has a love for being
            a part of building meaningful solutions and telling important stories by balancing
            technical competency with artistic vision.
          </Typography>
